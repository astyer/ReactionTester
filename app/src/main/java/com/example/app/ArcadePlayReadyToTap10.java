...
public class ArcadePlayReadyToTap10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arcade_play_ready_to_tap10);
        ...
        toNext.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                if(arcadeCounter > 9)
                {
                    ...
                    Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadeResults.class);
                ...
                else
                {
                    ...
                    if(r == 0)
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap1.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap2.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap3.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap4.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap5.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap6.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap7.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap8.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap10.this, ArcadePlayReadyToTap9.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
