...
public class ArcadePlayReadyToTap4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_arcade_play_ready_to_tap4);
        ...
        toNext.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                if(arcadeCounter > 9)
                {
                    ...
                    Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadeResults.class);
                ...
                else
                {
                    ...
                    if(r == 0)
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap1.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap2.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap3.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap5.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap6.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap7.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap8.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap9.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
                    ...
                    {
                        Intent intent = new Intent(ArcadePlayReadyToTap4.this, ArcadePlayReadyToTap10.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        startActivity(intent);
                        overridePendingTransition(0,0);
                    }
